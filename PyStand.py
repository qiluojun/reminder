...
class Ui_MainWindow(object):
	...
	def setupUi(self, MainWindow):
		...
		# 创建四个按钮并连接到set_entry_text函数
		self.button_5 = QPushButton("5 minutes")
		self.button_5.clicked.connect(lambda: self.set_entry_text(5))
		self.button_10 = QPushButton("10 minutes")
		self.button_10.clicked.connect(lambda: self.set_entry_text(10))
		self.button_15 = QPushButton("15 minutes")
		self.button_15.clicked.connect(lambda: self.set_entry_text(15))
		self.button_20 = QPushButton("20 minutes")
		self.button_20.clicked.connect(lambda: self.set_entry_text(20))
        # 创建一个新的布局来放置这些按钮
		button_layout = QHBoxLayout()
		button_layout.addWidget(self.button_5)
		button_layout.addWidget(self.button_10)
		button_layout.addWidget(self.button_15)
		button_layout.addWidget(self.button_20)
		...
		with open("reminder_QT5_v2\\reminder_content.txt", "r",encoding='utf-8') as file:
			for line in file:
	...
	def set_entry_text(self, minutes):
        # 设置self.entry的文本为传入的分钟数
		self.entry.setText(str(minutes))
